 ...
 */
export function getLastDigits(num: number, digitNum?: number): number {
 ...
 */
export function getCoordinateFromHash(
  hash: number,
  ...
  // determine which quadrant the shape will be placed in. 0-3 is the left half of the
  // canvas, 3-6 is the center, and 6-9 is the right half
  //
 ...
 * radius of a shape.
 */
export function getDimensionFromHash(
  hash: number,
  maxWidth: number,
  maxHeight: number
